  ...
  return (
    ...
    >
      ...
      <ContactItem
        ...
        value={_.get(_.find(data.resume["@graph"][1].contactPoint,{contactType:"Preferred"}), 'telephone', "")}
        link={`tel:${_.get(_.find(data.resume["@graph"][1].contactPoint,{contactType:"Preferred"}), 'telephone', "")}`}
      />
      <ContactItem
        label={_.get(data,'profile.website.heading', t("Website"))}
        value={_.get(data,'resume["@graph"][1].sameAs[0]',"")}
        link={_.get(data,'resume["@graph"][1].sameAs[0]',"")}
      />
      <ContactItem
        label={_.get(data,'profile.email.heading' ,t("Email"))}
        value={_.get(_.find(data.resume["@graph"][1].contactPoint,{contactType:"Preferred"}), 'email', "")}
        link={`mailto:${_.get(_.find(data.resume["@graph"][1].contactPoint,{contactType:"Preferred"}), 'email', "")}`}
      />

...
Your information can be exported to structured data format and imported back into the application from anywhere, all you need is your structured data file. This feature makes it easy to update your resume, upload your file (or have it preloaded from local storage), edit the resume and download it again or print it as PDF.
